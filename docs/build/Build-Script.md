...
```
./tools/build.py --target-os=nuttx --target-arch=arm --target-board=nucleo-f767zi --nuttx-home="..."
```
...
---
#### `--target-board`
* `artik10` | `artik05x` | `rpi2` | `rpi3` | `nucleo-f767zi` | empty

Specify target board.

```
./tools/build.py --target-os=nuttx --target-arch=arm --target-board=nucleo-f767zi
```
